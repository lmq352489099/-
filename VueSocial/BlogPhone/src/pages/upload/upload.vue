  ...
  <div>
    ...
    <div class="upload">
      <div v-if="userInfo._id">
        ...
        <a
          class="weui-btn weui-btn_primary btn-put"
          style="margin: 20px "
          @click.prevent.once="put"
        >发送</a>
      </div>
...
export default {
  ...
  methods: {
    ...
    put() {
      ...
      console.log(param.get("content"));
      console.log(param.get("file2"));

      console.log(132);

      self.axios
        .post("/cross/upload/uploadFile", param, {
          headers: {
